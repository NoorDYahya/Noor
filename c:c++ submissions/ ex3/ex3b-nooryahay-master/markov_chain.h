...
/***************************/
/*   insert typedefs herdcne  */
/***************************/
typedef void *vec_elem;
typedef void (*PrintFunc)(vec_elem item);
typedef int (*CmpFunc)(vec_elem , vec_elem); //const?
typedef void (*FreeFunc)(vec_elem);
typedef void* (*CopyFunc)(vec_elem);
typedef bool (*IsLast)(vec_elem);
/***************************/
